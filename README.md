...
Ценообразование: (20% Стоимость компонентов) + (3% Расходные материалы) + (5% Затраты на содержание, ремонт и МИР оборудования) + (10% Заработная плата) + (50% Фонд безусловного базового дохода компании, включая налоги) + (5% Маркетинг, затраты на рекламу и прочие способы привлечения клиентов) + (2% Непредвиденные расходы на изменение внешних условий) + (5% чистая прибыль компании) * k, k - коэффициент горизонта неопределенности
